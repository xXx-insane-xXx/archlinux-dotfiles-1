...
(custom-set-variables
 ...
 '(package-selected-packages
   '(ancient-one-dark-theme atom-one-dark-theme omnisharp lsp-java obsidian obsidian-theme sublimity pulsar adaptive-wrap grep-a-lot ace-mc emmet-mode nyan-mode doom-themes gruber-darker-theme spacemacs-theme zenburn-theme gruvbox-theme solarized-theme org cyberpunk-theme))
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:inherit nil :extend nil :stipple nil :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight regular :height 120 :width normal :foundry "UKWN" :family "Prasevka Iomata MNL v1"))))
